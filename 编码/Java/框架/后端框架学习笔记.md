...
20.视图配置的时候，可以设置多个文件夹吗？可以配置多种视图后缀吗？

A:



21:Spring MVC之中form标签，jstl标签，sf标签，el表达式，各自使用在什么地方并且有什么区别？

A:



22:Spring MVC的模板技术有哪些？

A:



23:Spring MVC后端传给前端值，怎么传，有哪些方法？

A:



23:Spring MVC前端传给后端值，怎么传，有哪些方法？
