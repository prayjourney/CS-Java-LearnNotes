...
##### 179 : 数组和List参数
A : 一般情况下，我们使用的是基本的数据类型，但是如果要使用数组，List，就需要看这块的内容了
![img](../../img/cover-5.png)
...
![img](../../img/20210715163314.png)
![img](../../img/20210715163236.png)
...
![img](../../img/20210715163116.png)
![img](../../img/20210715163152.png)
...
```
后端接收的时候，需要使用`@RequestBody`注解，使用List类型接收即可，参数是放在http请求的body部分的，普通的参数fileName可以放到query参数之中
```java
/**
 * 一次性存放多条数据，list导入
 *
